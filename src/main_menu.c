...
#define MAIN_MENU_BUTTON_TEXTURE_WIDTH 916
#define MAIN_MENU_BUTTON_TEXTURE_HEIGHT 240

#define MAIN_MENU_TITLE_TEXTURE_WIDTH 1600
#define MAIN_MENU_TITLE_TEXTURE_HEIGHT 320
